...
- 반려동물의 정보를 기록할 수 있는 탭입니다. 최대한 정보를 자세하게 입력하는 것이 좋습니다. 기록을 하면서 내가 기르던 반려동물에 대해 상기하는 효과도 있습니다. 🌿
- 참고로, 수정하고 싶은 마음이 들어 ‘이전으로’를 눌러 돌아가면 해당 데이터들이 남아 있고, 그리고 입력하지 않은 채로 ‘다음으로’를 누르면 경고문이 뜹니다.
...
### 대화하기
- 내가 추가했던 동물들의 목록이 나오고 그 중에서 동물을 선택하여 대화를 나눌 수 있습니다. 
